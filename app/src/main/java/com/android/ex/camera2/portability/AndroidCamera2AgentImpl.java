...
class AndroidCamera2AgentImpl extends CameraAgent {
                        ...
                        switch (afState) {
                            ...
                            case CaptureResult.CONTROL_AF_STATE_PASSIVE_UNFOCUSED: {
                                if (afStateChanged && mPassiveAfCallback != null) {
                                    ...
                                    mPassiveAfCallback.onAutoFocusMoving(
                                            ...
                                            mCameraProxy);
                                    android.util.Log.i("Tag","CONTROL_AF_STATE_PASSIVE_SCAN");
                                }
                                break;
                            }
                            ...
                            case CaptureResult.CONTROL_AF_STATE_NOT_FOCUSED_LOCKED: {
                                ...
                                if (mOneshotAfCallback != null) {
                                    ...
                                    android.util.Log.i("Tag","CONTROL_AF_STATE_FOCUSED_LOCKED" +
                                            "---afState:"+afState);
                                }
                                break;
                            }
                            ...
                            case CaptureResult.CONTROL_AE_STATE_LOCKED: {
                                ...
                                if (mOneshotCaptureCallback != null) {
                                    ...
                                    try {
                                        ...
                                        android.util.Log.i("Tag"," mSession.capture");
                                        mSession.capture(
                                                mPersistentSettings.createRequest(mCamera,
                                                        CameraDevice.TEMPLATE_STILL_CAPTURE,
                                                        mCaptureReader.getSurface()),
    ...
    private class AndroidCamera2ProxyImpl extends CameraProxy {
        ...
        public boolean applySettings(CameraSettings settings) {
            android.util.Log.i("Tag","applySettings");
            if (settings == null) {
