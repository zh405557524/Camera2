...
public class FocusOverlayManager implements PreviewStatusListener.PreviewAreaChangedListener,
    ...
    public FocusOverlayManager(AppController appController,
                               List<CameraCapabilities.FocusMode> defaultFocusModes,
    ...
    private void initializeFocusAreas(int x, int y) {
        ...
        android.util.Log.i("Tag", "FocusOverLayManger-rec -initializeFocusAreast:" + mFocusArea.get(0).rect);
    }
    ...
    private void initializeMeteringAreas(int x, int y) {
        ...
        android.util.Log.i("Tag", "FocusOverLayManger-rec -initializeMeteringAreas:" + mMeteringArea.get(0).rect);
    ...
    public void onSingleTapUp(int x, int y) {
        ...
        android.util.Log.i("Tag", "x:" + x + "-----y:" + y);
